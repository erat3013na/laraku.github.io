...
@section('body')
    <div class="container">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-3">Hello Guesst</h1>
                <p>Silahkan isi data di bawah untuk mendaftar lomba</p>
            </div>
            <div class="container">
                <form action="test4/create" method="post">
                {{--!!!!! jng lupa pake @csrf klo gk mau error 419 !!!!!--}}
                @csrf
                    <div class="form-group col-md-6">
                        <label for="tim"><h4>Nama TIM : </h4></label>
                        <input type="text" class="form-control" id="tim" name="tim" placeholder="Nama TIM">
                    </div>
                    <div class="container">
                        <h5>Anggota 1:</h5>
                        <div class="form-group col-md-6">
                            <label for="nama-user1">Nama Anggota 1: </label>
                            <input type="text" class="form-control" id="nama-user1" name="anggota1" placeholder="Nama Anggota 1">
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="nisn-user1" name="nisn1" placeholder="NISN Anggota 1">
                        </div>
                    </div>
                    <div class="container">
                        <h5>Anggota 2:</h5>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama-user2" name="anggota2" placeholder="Nama Anggota 2">
                        </div>
                        <div class="container form-group">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="nisn-user2" name="nisn2" placeholder="NISN Anggota 2">
                        </div>
                        </div>
                        <div class="container">
                            <h5>Anggota 3:</h5>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="nama-user3" name="anggota3" placeholder="Nama Anggota 3">
                            </div>
                            <div class="container form-group">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" id="nisn-user3" name="nisn3" placeholder="NISN Anggota 3">
                            </div>
                        </div>
